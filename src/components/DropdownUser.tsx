    ...
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={userData ? userData.profilePicture : 'Loading...'} alt="User" className="h-12 w-12 rounded-full border-2 border-white dark:border-gray-700 shadow-lg object-cover"/>
        </span>
