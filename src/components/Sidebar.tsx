...
const Sidebar = ({ sidebarOpen, setSidebarOpen}: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gradient-to-t from-[#351053] to-[#7323B1] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <NavLink
                  to="/dashboardforums"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('dashboardforums') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                       <svg
                          className="fill-current"
              ...
              {userData && userData.userType === 'organization' && userData && userData.subscriptionStatus === 'Subscribed' && (
                <>
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('professionals')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/professionals' ||
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/remove-professional"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Manage Mental Health Professionals
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                            ...
                            >
                               Pending Mental Health Professional Applications
                            </NavLink>
                          </li>
                        </ul>
                      </div>
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <li>
                            ...
                            >
                              Register a New Organization or Admin
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                            ...
                            >
                              Manage Mental Health Organizations
                            </NavLink>
                          </li>
            ...
            {userData && userData.userType === "organization" &&  userData && userData.subscriptionStatus === "Subscribed" && (  
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/forms' ||
                          pathname.includes('manageforums')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
             ...
             {userData && userData.userType === "admin" && (
              <li>
                <NavLink
                  to="/subscriptions"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('subscriptions') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
             ...
             {userData && userData.userType === "organization" && userData && userData.subscriptionStatus != "Subscribed"  && (
              <li>
                ...
                >
                  ...
                  {/* display the subscription of the organiazation */}
               {userData && userData.userType === "organization" && userData && userData.subscriptionStatus === "Subscribed" && (
                 <li>
                 <NavLink
                   to="/my-subscription"
