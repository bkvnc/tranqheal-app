        ...
        <>
            <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                ...
                <div className="flex items-center">
                    ...
                    <button className="h-12 w-50 mb-3 ml-100 inline-flex items-center justify-center rounded-md bg-[#9F4FDD] py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">Create Post
                        ...
                        <tbody>
                            <tr>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        ABC Mental Health Organization
                                    </h5>
                                    <p className="text-sm">migueltrinidad@gmail.com</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">Suicide</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            ...
                            <tr>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    ...
                                    <p className="text-sm">alanmikko@gmail.com</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">Suicide</p>
                                </td>
                            ...
                            <tr>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    ...
                                    <p className="text-sm">fritsasing@gmail.com</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">Suicide</p>
                                </td>
                            ...
                            <tr>
                                <td className="py-5 px-4 pl-9 xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        XYZ MENTAL ORGANIZATION
                                    </h5>
                                    <p className="text-sm">XYZMENTAL@gmail.com</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">Suicide</p>
                                </td>
