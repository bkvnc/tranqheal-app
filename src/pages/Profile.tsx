...
import sampleImage from '../images/sample-images/sharko.jpg';
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={sampleImage} alt="profile" className='rounded-full w-50 h-35'/>
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            ...
            {/* <div className="mx-auto mt-4.5 mb-5.5 grid max-w-200 grid-cols-2 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  475
                </span>
                <span className="text-sm ml-2">Calls Handled</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  79
                </span>
                <span className="text-sm ml-2">Resources Published</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  95%
                </span>
                <span className="text-sm ml-2">Five-Star Rating Percentage</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  100%
                </span>
                <span className="text-sm ml-2">Positive Feedback Percentage</span>
              </div>
            </div> */}
