              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center rounded bg-[#9F4FDD] py-2 px-6 font-medium text-gray hover:shadow-1"
                      type="submit"
                      onClick={fireToast}
                    >
                      Save
                ...
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full">
                      <img src={sampleImage} alt="User" className="h-14 w-14 rounded-full"/>
                    </div>
                    <div>
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center rounded bg-[#9F4FDD] py-2 px-6 font-medium text-gray hover:bg-opacity-70"
                      type="submit"
                    >
                      Save
                    </button>
